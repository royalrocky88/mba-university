...
export const news: NewsItem[] = [
  {
    ...
    body: [
      'Meridian School of Business has opened applications for the MBA Class of 2027 across all eight specialisations. The intake remains capped at 480 seats, unchanged from last year, in line with our commitment to a section size of no more than sixty.',
  ...
  },
  {
    ...
    body: [
      ...
      'Three hundred and forty organisations participated, of which forty-one were first-time recruiters at Meridian. The Career Development Centre notes that the alumni referral programme originated 94 of the offers made, a figure that has now grown for four consecutive years.',
    ],
  },
  {
  ...
  },
  {
    ...
    title: 'Meridian Business Summit returns in October',
    date: '2026-05-05',
    category: 'Events',
    ...
    body: [
      'The eleventh Meridian Business Summit will take place on 16 and 17 October 2026 at the Greater Noida campus. This year’s theme, "Capital After Certainty", examines investment decision-making in an environment of persistent policy and supply-chain volatility.',
  ...
  },
  {
    ...
    body: [
      'Meridian has signed exchange agreements with three additional business schools in Singapore, Ho Chi Minh City and Jakarta, taking the total partner network to eleven institutions across Europe and South-East Asia.',
  ...
  },
  {
    ...
    date: '2026-03-30',
    category: 'Events',
    author: 'Meridian Ventures',
    readMinutes: 2,
    excerpt:
      'Selected teams receive ₹15 lakh in pre-seed capital, campus workspace and twelve months of structured mentorship.',
    body: [
      'Meridian Ventures, the campus incubator, has opened applications for its fifth cohort. Up to eight teams will be selected, each receiving ₹15 lakh in pre-seed capital, dedicated workspace on campus, and twelve months of structured mentorship.',
  ...
  },
  {
    ...
    title: 'Meridian re-accredited with NAAC A++ grade',
    date: '2026-02-11',
    category: 'Campus',
    ...
    body: [
      'Following a five-day peer team review in January, the National Assessment and Accreditation Council has re-accredited Meridian School of Business with an A++ grade and a cumulative grade point average of 3.71 out of 4.',
